...
<CardGroup cols={2}>
  <Card title="Client Configuration" icon="server" href="/python/client/client-configuration">
=======
...
>>>>>>> 3ff31be (move docs)
  ...
  <Card title="Agent Configuration" icon="brain" href="/python/agent/agent-configuration">
=======
...
<Steps>
  <Step title="Client Configuration">
    ...
    **Start here:** [Client Configuration Guide →](/python/client/client-configuration)
=======
...
>>>>>>> 3ff31be (move docs)
  ...
  <Step title="Agent Configuration">
    ...
    **Continue with:** [Agent Configuration Guide →](/python/agent/agent-configuration)
=======
...
>>>>>>> 3ff31be (move docs)
  ...
  <Step title="Advanced Topics">
    ...
    **Learn more:** [Connection Types](/python/client/connection-types) | [Server Manager](/python/agent/server-manager) | [LLM Integration](/python/agent/llm-integration)
=======
...
<Tip>
**New to mcp_use?** Start with the [Quickstart Guide](/python/getting-started/quickstart) for a basic introduction, then return here for detailed configuration options.
=======
