...
<Info>
<<<<<<< HEAD
This guide covers MCPClient configuration options for connecting to MCP servers. For agent configuration, see the [Agent Configuration](/python/agent/agent-configuration) guide.
=======
