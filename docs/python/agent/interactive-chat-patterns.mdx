...
<<<<<<< HEAD
  ...
  <Card title="Multi-Server Setup" icon="server" href="/python/advanced/multi-server-setup">
    Stream output from agents using multiple MCP servers
  </Card>
  <Card title="Security Best Practices" icon="shield" href="/python/advanced/security">
=======
